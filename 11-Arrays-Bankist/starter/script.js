...
// Lecture 4 - ForEach With Maps and Sets 🧑‍💻
...
// Set
// Important - in sets there is no such index or key 
//However programmers used use a _ to ignore it and  use the forEach Loop
...
const checkDogs = function (dogsJulia, dogsKate) {
  // Shallow copy of Julia's array
  const correctedJulia = dogsJulia.slice();

  // Remove the first and last two elements (cat ages)
...
// Test data
const dogsJulia = [3, 5, 2, 12, 7, 9, 16, 6, 8, 3];
const dogsKate = [4, 1, 15, 8, 3, 10, 5, 6, 1, 4];

const result = checkDogs(dogsJulia, dogsKate);
console.log(result);

result.forEach(function(age,i,arr){
  if(age>=3)
  {
...
//Lecture - 8 - Data Transformation: map,filter,reduce 🧑‍💻

/* There are three data transformation methods which are map, filter and reduce
Map - create a new array according to our need without affecting the primary array
filter - as name stands make a new array by filtering the primary array 
reduce - create a new array by reducing the number of elements in the primary array or some to one such sum of the all elements in a new array 
*/

//Lecture 9 - The Map Method 🧑‍💻

const eurToUsd = 1.1;
 //movements array is defined above 

 // Using the foreach method  - Map Example
 /* const movementsUSD = movements.map(function (mov) {
    return mov * eurToUsd;
   });
   */

  // Using the arrow funnctions for the above foreach 
  ...
  //Movement descrippting usinng foreach and arrow function which displays either deposited or withdraw depend on the sign of the mov 
  ...
  //Lecture 10 - Computing Usernames 🧑‍💻
...
// Lecture 14 - The Magic of Chaining Methods 🧑‍💻
...
// Lecture 16 - The find Method 🧑‍💻

// Filter returns all the elemnts while find method returns the first value pnly - check the console to get the idea behind it
...
// Lecture 16 - The findIndex Method 🧑‍💻


//Lecture 17 - Sum and Every Method 🧑‍💻
...
// Lecture 18 - Flat and FlatMap Method 🧑‍💻
...
// Lecture 20 - More Ways of Creating and Filling Arrays 🧑‍💻
...
// Lecture 21 - Summary - Which Array Method to Use? 🧑‍💻



// Lecture 22 - Array Method Practice 🧑‍💻
...
/// Note that some of the code segements are commented in some lectures due to declared multiple times and causing bugs 
//Please use to check the lectures and practice accordingly 