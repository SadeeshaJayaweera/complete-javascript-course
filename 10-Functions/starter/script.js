...
// Lecture 9 - Immediately Invoked Function Expressions (IIFE) 🧑‍💻

// Immediately Invoked Function Expressions (IIFE)

//This is not the way to make only one time runnable function 
/* const runOnce = function () {
  console.log('This will never run again');
};
runOnce(); */

// IIFE - this function is runnable at once and will be run once initiated 
//what we do here is make the function an expression by using () and calling end of the function 
//this function does not have a function name either 
(function () {
  console.log('This will never run again');
  const isPrivate = 23;
})();
...
// Lecture 10 - Closures 🧑‍💻
/*what happens in closures is when the function calls itself the internal value of the 
does not become initial which is passengerCount that increment by one and repeat the process 
without getting rid the value each time the calling function appears 
*/
...
console.dir(booker); // can see the closures 

//Lecture 11 - More Closure Examples 🧑‍💻
...
g();
f();
console.dir(f); //to see the closure 
...
const boardPassengers = function (n, wait) {
  ...
  }, wait * 1000);// in here the timer will be set to 1000milli seconds which the code block is executed after 3 seconds due to setTimeout Function

  console.log(`Will start boarding in ${wait} seconds`);// this will be printed first then the above will be printed due to timer check the output 
};

const perGroup = 1000; 
boardPassengers(180, 3);

//Lecture 12 - Coding Challenge 2 🧑‍💻
/* 
...
})(); //() stands calling the function (statement) for one time 
